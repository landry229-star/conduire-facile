    ...
    head: () => ({
        meta: [
            ...
            { property: "og:title", content: "À propos — L'Excellence Auto-École" },
            {
                ...
                content: "Notre histoire, notre équipe et notre flotte au service de votre permis.",
            },
...
const equipe = [
    {
        ...
        detail: "22 ans d'expérience, formateur de moniteurs.",
    },
    {
        nom: "Sylvie H.",
        role: "Responsable code",
        detail: "Anime les salles de code à Cotonou et Porto-Novo.",
    },
    {
        nom: "Bienvenu T.",
        role: "Moniteur poids lourd",
        detail: "Spécialiste C, CE et transport de marchandises.",
    },
    {
        nom: "Grâce D.",
        role: "Monitrice moto",
        detail: "Formation AM, A1, A et sécurité des zémidjans.",
    },
];
        ...
        <PublicShell>
            <main className="px-5 py-10">
                ...
                <p className="mt-3 max-w-2xl text-sm leading-relaxed text-charcoal/60">
                    L'Excellence Auto-École est née en 2009 à Cotonou d'un constat simple : la route
                    béninoise exige plus qu'un permis, elle exige des réflexes. Nous formons chaque
                    année des centaines d'élèves — futurs conducteurs de voiture, conducteurs de
                    zémidjan, chauffeurs de poids lourd et de transport en commun — avec la même
                    exigence : comprendre avant de mémoriser, maîtriser avant de passer l'examen.
                </p>
                ...
                <section className="mt-8 grid grid-cols-2 gap-3 md:grid-cols-4">
                    {chiffres.map((c) => (
                        <div
                            key={c.label}
                            className="rounded-lg bg-white p-4 ring-1 ring-charcoal/10"
                        >
                    ...
                    <div className="mt-4 grid gap-4 md:grid-cols-3">
                        <article className="rounded-lg bg-white p-5 ring-1 ring-charcoal/10">
                            <h3 className="text-sm font-semibold">
                                1. Le code, en salle ou en ligne
                            </h3>
                            <p className="mt-2 text-xs leading-relaxed text-charcoal/60">
                                25 leçons illustrées, quiz corrigés et examens blancs chronométrés.
                                Vous choisissez la salle avec un moniteur ou la plateforme en ligne,
                                à votre rythme.
                            </p>
                        </article>
                        <article className="rounded-lg bg-white p-5 ring-1 ring-charcoal/10">
                            ...
                            <p className="mt-2 text-xs leading-relaxed text-charcoal/60">
                                Chaque leçon valide des compétences précises (créneau, démarrage en
                                côte, ronds-points) consignées dans votre livret de conduite
                                numérique.
                            </p>
                        </article>
                        <article className="rounded-lg bg-white p-5 ring-1 ring-charcoal/10">
                            ...
                            <p className="mt-2 text-xs leading-relaxed text-charcoal/60">
                                Nous ne présentons un élève que lorsque ses résultats blancs sont
                                stables. C'est ce qui explique notre taux de réussite.
                            </p>
                        </article>
                    </div>
                </section>
                    ...
                    <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                        {equipe.map((m) => (
                            ...
                            >
                                ...
                                <p className="mt-2 text-[11px] leading-relaxed text-charcoal/60">
                                    {m.detail}
                                </p>
                            </article>
                        ))}
                ...
                <section className="mt-12 rounded-lg bg-charcoal p-6 text-white">
                    ...
                    <p className="mt-2 max-w-2xl text-xs leading-relaxed text-white/70">
                        L'Excellence Auto-École est agréée par le Ministère des Infrastructures et
                        des Transports sous le numéro N°2024/MT-042. Nos véhicules sont assurés,
                        contrôlés techniquement et équipés de la double commande. Nos moniteurs
                        détiennent le certificat d'aptitude à l'enseignement de la conduite.
                    </p>
                    <Link
                        to="/contact"
