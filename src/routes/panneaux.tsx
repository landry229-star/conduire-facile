...
import { ArrowLeft, AlertTriangle, Ban, CircleCheck, Info, ChevronRight } from "lucide-react";
import {
    SignShape,
    VirageDroiteIcon,
    VirageGaucheIcon,
...
const sections: Section[] = [
    {
        ...
        signs: [
            {
                type: "danger",
                label: "Virage dangereux à droite",
                desc: "La route tourne brusquement vers la droite. Réduisez votre vitesse.",
            },
            {
                type: "danger",
                label: "Virage dangereux à gauche",
                desc: "La route tourne brusquement vers la gauche. Ne vous rapprochez pas de la ligne médiane.",
            },
            {
                type: "danger",
                label: "Dos d'âne",
                desc: "Ralentissez fortement. Franchissez lentement pour protéger les suspensions.",
            },
            {
                type: "danger",
                label: "Passage à niveau",
                desc: "Préparez-vous à céder le passage aux trains. Ne vous engagez pas si la barrière descend.",
            },
            {
                type: "danger",
                label: "Chaussée rétrécie",
                desc: "La largeur utile diminue. Cédez le passage si nécessaire.",
            },
            {
                type: "danger",
                label: "Chaussée glissante",
                desc: "Adaptez votre allure. Évitez les freinages brusques en cas de pluie.",
            },
        ],
    },
    {
        ...
        signs: [
            {
                type: "interdiction",
                label: "Interdiction de tourner à gauche",
                desc: "Vous ne pouvez pas effectuer ce virage. Continuez tout droit.",
            },
            {
                type: "interdiction",
                label: "Sens interdit",
                desc: "Ne pas entrer par cette voie. Contournement obligatoire.",
            },
            {
                type: "interdiction",
                label: "Stationnement interdit",
                desc: "Vous ne pouvez ni vous arrêter ni stationner ici.",
            },
            {
                type: "interdiction",
                label: "Limitation de vitesse — 50 km/h",
                desc: "Vitesse maximale autorisée dans cette zone. Radar en agglomération.",
            },
            {
                type: "interdiction",
                label: "Limitation de vitesse — 30 km/h",
                desc: "Zone à circulation apaisée ou zone scolaire.",
            },
        ],
    },
    {
        ...
        signs: [
            {
                type: "obligation",
                label: "Virage à droite obligatoire",
                desc: "Vous devez tourner obligatoirement à droite.",
            },
            {
                type: "obligation",
                label: "Contournement obligatoire",
                desc: "Contournez l'obstacle par la droite uniquement.",
            },
        ],
    },
    {
        ...
        signs: [
            {
                type: "indication",
                label: "Sens unique",
                desc: "La circulation est autorisée uniquement dans le sens de la flèche.",
            },
            {
                type: "indication",
                label: "Hôpital",
                desc: "Établissement de soins à proximité. Donnez la priorité aux ambulances.",
            },
            {
                type: "indication",
                label: "Parking",
                desc: "Stationnement autorisé et aménagé dans cette zone.",
            },
        ],
    },
    {
        ...
        signs: [
            {
                type: "stop",
                label: "STOP",
                desc: "Arrêt complet obligatoire. Cédez le passage à tous les autres usagers.",
            },
            {
                type: "priority",
                label: "Priorité ponctuelle",
                desc: "Vous avez la priorité sur la route qui se croise.",
            },
            {
                type: "ceder",
                label: "Cédez le passage",
                desc: "Cédez le passage aux usagers arrivant à hauteur. Ralentissez et stoppez si nécessaire.",
            },
        ],
    },
];
    ...
    return (
        <div className="min-h-screen bg-ivory text-charcoal">
            ...
            <header className="px-5 pb-2 pt-10">
                <div className="max-w-[60ch]">
                    ...
                    <p className="text-pretty text-base text-charcoal/70">
                        Maîtrisez les panneaux du code de la route avant même votre première leçon.
                        Cliquez sur une famille pour découvrir les significations.
                    </p>
                </div>
            </header>
            ...
            <main className="px-5 py-8">
                ...
                {(activeSection ? sections.filter((s) => s.key === activeSection) : sections).map(
                    (s) => (
            ...
            <footer className="border-t border-charcoal/5 bg-zinc-50 px-5 py-10">
                <p className="text-[11px] leading-relaxed text-charcoal/50">
                    © {new Date().getFullYear()} L'Excellence Auto-École. Référentiel basé sur la
    ...
    return (
        <div className="flex gap-4 rounded-xl bg-white p-4 ring-1 ring-black/5">
            ...
            <div className="min-w-0">
                ...
                <p className="mt-1 text-xs leading-relaxed text-charcoal/60">{sign.desc}</p>
            </div>
        </div>
    );
}
