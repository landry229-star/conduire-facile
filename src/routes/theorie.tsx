  ...
  head: () => ({
    meta: [
      { title: "Phase théorique en ligne — L'Excellence Auto-École" },
      {
        name: "description",
        content:
          "Cours complet de code de la route : 25 leçons illustrées, comme en auto-école. Schémas, exemples, erreurs à éviter, résumés et progression sauvegardée.",
      },
    ],
  }),
  component: Theorie,
...
const STORAGE_KEY = "theorie:completed:v2";
...
function LessonIllustration({ kind }: { kind: IllustrationKind }) {
  ...
  if (kind === "signs-interdiction") {
    return (
      <div className="grid grid-cols-3 gap-3">
        ...
        <SignThumb type="interdiction" icon={<StationnementInterditIcon />} label="Stationnement" />
      </div>
    );
  }
  if (kind === "signs-obligation") {
    return (
      <div className="grid grid-cols-3 gap-3">
        <SignThumb type="obligation" icon={<TournerDroiteIcon />} label="Tournez à droite" />
  ...
  if (kind === "intersection") {
    return (
      <svg viewBox="0 0 240 200" className="w-full max-w-xs">
        ...
        {/* dashed center lines */}
        <line x1="120" y1="0" x2="120" y2="80" stroke="white" strokeWidth="2" strokeDasharray="8 6" />
        <line x1="120" y1="140" x2="120" y2="200" stroke="white" strokeWidth="2" strokeDasharray="8 6" />
        <line x1="0" y1="110" x2="90" y2="110" stroke="white" strokeWidth="2" strokeDasharray="8 6" />
        <line x1="150" y1="110" x2="240" y2="110" stroke="white" strokeWidth="2" strokeDasharray="8 6" />
        {/* car coming from right (priority) */}
        <rect x="186" y="100" width="34" height="18" rx="3" fill="#008751" />
        <text x="203" y="92" textAnchor="middle" fontSize="9" fill="#008751" fontWeight="bold">PRIORITÉ</text>
        {/* my car (waiting) */}
        <rect x="106" y="148" width="22" height="34" rx="3" fill="#e8112d" />
        <text x="117" y="195" textAnchor="middle" fontSize="9" fill="#e8112d" fontWeight="bold">VOUS</text>
        {/* arrow priority */}
        <path d="M186,109 L150,109" stroke="#008751" strokeWidth="2" markerEnd="url(#ar2)" />
        <defs>
          <marker id="ar2" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto">
  ...
  if (kind === "roundabout") {
    return (
      <svg viewBox="0 0 240 240" className="w-full max-w-xs">
        ...
        {/* arrows */}
        <path d="M120,75 A45,45 0 0,1 165,120" fill="none" stroke="#008751" strokeWidth="3" markerEnd="url(#ar3)" />
        <defs>
          <marker id="ar3" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto">
            <path d="M0,0 L10,5 L0,10 z" fill="#008751" />
          </marker>
        </defs>
        {/* my car entering */}
        <rect x="109" y="190" width="22" height="32" rx="3" fill="#e8112d" />
        <text x="120" y="235" textAnchor="middle" fontSize="9" fill="#e8112d" fontWeight="bold">CÉDEZ</text>
        <text x="120" y="125" textAnchor="middle" fontSize="9" fill="#18181b" fontWeight="bold">Sens unique</text>
      </svg>
    );
  }
  if (kind === "safety-distance") {
    return (
      <svg viewBox="0 0 320 100" className="w-full max-w-sm">
        ...
        <line x1="0" y1="55" x2="320" y2="55" stroke="white" strokeWidth="2" strokeDasharray="14 10" />
        <rect x="30" y="38" width="44" height="22" rx="3" fill="#94a3b8" />
        <rect x="210" y="38" width="44" height="22" rx="3" fill="#008751" />
        <line x1="76" y1="50" x2="208" y2="50" stroke="#e8112d" strokeWidth="1.5" strokeDasharray="3 3" />
        <text x="142" y="22" textAnchor="middle" fontSize="11" fontWeight="bold" fill="#e8112d">~ 2 secondes</text>
        <text x="142" y="90" textAnchor="middle" fontSize="9" fill="#18181b">50 m à 90 km/h</text>
      </svg>
    );
  }
  if (kind === "blind-spot") {
    return (
      <svg viewBox="0 0 240 180" className="w-full max-w-xs">
        ...
        <text x="60" y="170" fontSize="9" fill="#e8112d" fontWeight="bold">Angle mort</text>
        <text x="155" y="170" fontSize="9" fill="#e8112d" fontWeight="bold">Angle mort</text>
        <text x="50" y="35" fontSize="9" fill="#16a34a" fontWeight="bold">Vu dans rétro</text>
      </svg>
    );
  }
  if (kind === "seatbelt") {
    return (
      <svg viewBox="0 0 200 160" className="w-full max-w-xs">
        ...
        {/* belt */}
        <path d="M75,40 L120,85 L120,120 L80,120" fill="none" stroke="#e8112d" strokeWidth="5" strokeLinejoin="round" />
        <circle cx="120" cy="85" r="3" fill="#18181b" />
        <text x="100" y="155" textAnchor="middle" fontSize="9" fill="#18181b" fontWeight="bold">Sangle : épaule + bassin</text>
      </svg>
    );
  }
  if (kind === "helmet") {
    return (
      <svg viewBox="0 0 200 160" className="w-full max-w-xs">
        ...
        <path d="M65,80 Q65,45 100,45 Q135,45 135,80 L135,95 L65,95 Z" fill="#60a5fa" opacity="0.85" />
        <rect x="50" y="105" width="100" height="8" fill="#27272a" />
        {/* strap */}
        <path d="M55,110 L70,135 L130,135 L145,110" fill="none" stroke="#e8112d" strokeWidth="3" />
        <text x="100" y="155" textAnchor="middle" fontSize="9" fill="#18181b" fontWeight="bold">Norme ECE 22-05 + jugulaire</text>
      </svg>
    );
  }
  ...
  if (kind === "rain") {
    return (
      <svg viewBox="0 0 240 160" className="w-full max-w-xs">
        ...
        <line x1="0" y1="125" x2="240" y2="125" stroke="white" strokeWidth="2" strokeDasharray="12 8" />
        ...
        <text x="120" y="22" textAnchor="middle" fontSize="11" fontWeight="bold" fill="#60a5fa">Vitesse −10 km/h · feux ON</text>
      </svg>
    );
  }
  if (kind === "night") {
    return (
      <svg viewBox="0 0 240 140" className="w-full max-w-xs">
        ...
        <line x1="0" y1="110" x2="240" y2="110" stroke="#fbbf24" strokeWidth="1.5" strokeDasharray="10 8" />
        ...
        <text x="120" y="25" textAnchor="middle" fontSize="11" fontWeight="bold" fill="#fef3c7">Portée codes ≈ 30 m</text>
      </svg>
    );
  }
  if (kind === "fog") {
    return (
      <svg viewBox="0 0 240 140" className="w-full max-w-xs">
        ...
        <text x="120" y="25" textAnchor="middle" fontSize="11" fontWeight="bold" fill="#475569">Antibrouillards AV + AR · pas de pleins phares</text>
      </svg>
    );
  }
  if (kind === "lane-position") {
    return (
      <svg viewBox="0 0 240 160" className="w-full max-w-xs">
        ...
        {/* dashed line */}
        <line x1="120" y1="60" x2="120" y2="160" stroke="white" strokeWidth="3" strokeDasharray="12 8" />
        {/* yellow curb line */}
        <line x1="6" y1="0" x2="6" y2="160" stroke="#fbbf24" strokeWidth="4" />
        <line x1="234" y1="0" x2="234" y2="160" stroke="#fbbf24" strokeWidth="4" strokeDasharray="10 6" />
        <text x="60" y="40" fontSize="9" fontWeight="bold" fill="white">Continue</text>
        <text x="60" y="110" fontSize="9" fontWeight="bold" fill="white">Discontinue</text>
        <text x="180" y="35" fontSize="9" fontWeight="bold" fill="#a16207">Stat. interdit</text>
      </svg>
    );
  }
  if (kind === "pedestrian-crossing") {
    return (
      <svg viewBox="0 0 240 140" className="w-full max-w-xs">
        ...
        <text x="50" y="25" textAnchor="middle" fontSize="11" fontWeight="bold" fill="#e8112d">Arrêt obligatoire</text>
      </svg>
    );
  }
  if (kind === "tire-check") {
    return (
      <svg viewBox="0 0 240 140" className="w-full max-w-xs">
        ...
        <text x="160" y="40" fontSize="10" fontWeight="bold" fill="#18181b">Pression OK</text>
        <text x="160" y="60" fontSize="10" fill="#18181b">Témoin d'usure</text>
        <text x="160" y="76" fontSize="10" fill="#18181b">≥ 1,6 mm</text>
        <text x="160" y="100" fontSize="10" fontWeight="bold" fill="#16a34a">Vérif. mensuelle</text>
      </svg>
    );
  }
  if (kind === "first-aid") {
      ...
      <svg viewBox="0 0 240 140" className="w-full max-w-xs">
        ...
        {[
          ...
          <g key={step.letter}>
            ...
            <text x={step.x + 20} y="58" textAnchor="middle" fontSize="26" fontWeight="bold" fill="white">{step.letter}</text>
            <text x={step.x + 20} y="100" textAnchor="middle" fontSize="11" fontWeight="bold" fill="#18181b">{step.label}</text>
          </g>
        ))}
        <text x="120" y="128" textAnchor="middle" fontSize="10" fill="#18181b">117 Police · 118 Pompiers · 112 Urgences</text>
      </svg>
    );
  }
  if (kind === "alcohol") {
    return (
      <svg viewBox="0 0 240 140" className="w-full max-w-xs">
        ...
        <text x="120" y="42" textAnchor="middle" fontSize="11" fontWeight="bold" fill="#18181b">0,5 g/L</text>
        <text x="70" y="105" textAnchor="middle" fontSize="9" fill="#16a34a" fontWeight="bold">Légal</text>
        <text x="170" y="105" textAnchor="middle" fontSize="9" fill="#e8112d" fontWeight="bold">Sanction + risque vital</text>
        <text x="120" y="128" textAnchor="middle" fontSize="9" fill="#18181b">Métabolisme : −0,15 g/L par heure</text>
      </svg>
    );
  }
  if (kind === "child-seat") {
    return (
      <svg viewBox="0 0 240 140" className="w-full max-w-xs">
        ...
        <text x="120" y="135" textAnchor="middle" fontSize="10" fontWeight="bold" fill="#18181b">Siège homologué à l'arrière</text>
      </svg>
    );
  }
  if (kind === "parking-types") {
    return (
      <svg viewBox="0 0 240 140" className="w-full max-w-xs">
        ...
        <text x="40" y="90" textAnchor="middle" fontSize="9" fill="#18181b">Créneau</text>
        {/* perpendicular */}
        <rect x="95" y="40" width="28" height="55" rx="3" fill="#e8112d" />
        <rect x="130" y="40" width="28" height="55" rx="3" fill="#94a3b8" />
        <text x="125" y="108" textAnchor="middle" fontSize="9" fill="#18181b">Bataille</text>
        {/* angled */}
        <g transform="translate(180,40) rotate(35)">
          <rect x="0" y="0" width="28" height="55" rx="3" fill="#fbbf24" />
        </g>
        <text x="195" y="125" textAnchor="middle" fontSize="9" fill="#18181b">Épi</text>
      </svg>
    );
  }
  return null;
    ...
    <div className="min-h-screen bg-ivory text-charcoal">
      ...
      <header className="px-5 pb-2 pt-10">
        ...
        <p className="mb-6 max-w-[56ch] text-base text-charcoal/70">
          {modules.length} modules, {total} leçons illustrées avec schémas,
          exemples concrets et erreurs à éviter — comme en auto-école. Mode{" "}
          <strong>Résumé</strong> pour réviser avant chaque quiz.
        </p>
      </header>
