...
type SignType =
    "danger" | "interdiction" | "obligation" | "indication" | "stop" | "priority" | "ceder";
...
export function SensInterditIcon() {
    return <rect x="25" y="30" width="50" height="40" rx="4" fill="#18181b" />;
}
...
export function SensUniqueIcon() {
    return (
        <g>
            <path
                d="M30,45 L65,45 L55,35 M65,45 L55,55"
                fill="none"
                stroke="#18181b"
                strokeWidth="5"
                strokeLinecap="round"
