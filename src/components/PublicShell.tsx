    ...
    return (
        <footer className="border-t border-charcoal/5 bg-zinc-50 px-5 py-10">
            ...
            <nav className="mb-6 flex flex-wrap gap-x-5 gap-y-2 text-[11px] font-medium">
                <Link to="/a-propos" className="hover:text-benin-green">
                    À propos
                </Link>
                <Link to="/contact" className="hover:text-benin-green">
                    Contact & agences
                </Link>
                <Link to="/mentions-legales" className="hover:text-benin-green">
                    Mentions légales
                </Link>
                <Link to="/confidentialite" className="hover:text-benin-green">
                    Confidentialité
                </Link>
            </nav>
